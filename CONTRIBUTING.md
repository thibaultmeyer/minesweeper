...
This document explains how to contribute changes to the minesweeper project.
...
If unique, [open an issue](https://github.com/thibaultmeyer/minesweeper/issues) and answer the questions
...
minesweeper. This is easiest to do when you write clear, concise
...
Please be kind, remember that minesweeper comes at no cost to you,
...
Changes to minesweeper must be reviewed before they are accepted,
...
* To help the future maintainers of minesweeper, say five years
